                    ...
                    Container(
                      ...
                      child: ListView.builder(
                        ...
                        itemBuilder: (context, index) {
                          return Column(
                            children: [
                              Stack(children: [InkWell( onTap: () {Navigator.push(context, MaterialPageRoute(builder: (context)=> Shop()));
                              ...
                              borderRadius: BorderRadius.only(
                                ...
                                height: 60,
                                width: 60,
                                decoration: BoxDecoration(color: wcolor,shape: BoxShape.rectangle,boxShadow:[
                                  BoxShadow(color: ccolor,
                                  blurRadius: 0,
                                  spreadRadius: 0,)
                                ], ),
